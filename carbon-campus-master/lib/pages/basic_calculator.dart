...
class _ElectricScreenState extends State<ElectricScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //     child: Text(
      //       "ELECTRICITY",
      //       style: TextStyle(color: Colors.grey[900], fontWeight: FontWeight.w900, fontSize: 40, letterSpacing: 10),
      //     ),
      //   ),
      // ),
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                const TextStyle2(fieldName: "Electricity Usage: "),
                MyDropDown(
                    items: const [
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                const TextStyle2(fieldName: "Food: ", type: 1,),
                ...
                const TextStyle2(fieldName: "Other Expenses: ", type: 1,),
